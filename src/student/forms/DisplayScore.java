...
public class DisplayScore extends javax.swing.JDialog {
    ...
    public DisplayScore(java.awt.Frame parent, boolean modal, StudentInterface listener,String score) {
        super(parent, modal);
        initComponents();
...
//            java.util.logging.Logger.getLogger(DisplayScore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                DisplayScore dialog = new DisplayScore(new javax.swing.JFrame(), true);
